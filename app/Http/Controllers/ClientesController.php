...
class ClientesController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'cliente_pdf_licencia' => ['nullable', 'file', 'mimes:pdf', 'max:10240'], // 10MB como en ventas
        ], [
        ...
        try {
            ...
            if ($validated['cliente_tipo'] != 3) {
                ...
                // Si es empresa y tiene PDF, guardarlo
                if ($request->hasFile('cliente_pdf_licencia')) {
                    ...
                    // Si no hay archivo, asegurar que el campo sea null
                    $validated['cliente_pdf_licencia'] = null;
                }
            }

            // Log antes de crear
            Log::info('Creando cliente con datos:', [
                'datos' => array_except($validated, ['cliente_pdf_licencia'])
            ]);

    ...
    <div class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div class="pt-4">
            ...
            <div x-show="configuracion" 
                ...
                <!-- Empresas de JM -->
                <a href="empresas-importacion" class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-700 hover:text-white transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

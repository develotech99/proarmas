<nav class="flex flex-col h-full bg-slate-800" x-data="{ 
    ...
    <div class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        <div class="pt-4">
          ...
          <a href="proclasespistolas" class="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-700 hover:text-white transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                    </svg>
                    <span>Clases</span>

...
<body class="font-sans antialiased bg-slate-50">
    <div class="min-h-screen flex">
        ...
        <div id="mobile-sidebar"
            class="fixed inset-y-0 left-0 z-50 w-64 bg-slate-800 transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex-shrink-0">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center py-4">
                        ...
                        <button onclick="toggleMobileMenu()"
                            class="p-2 rounded-md text-slate-600 hover:text-slate-900 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-slate-500">

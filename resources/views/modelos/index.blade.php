...
<!-- Pasar datos iniciales (solo activos) -->
<script id="modelos-data" type="application/json">
    @json($modelos -> items())
</script>

<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"
    x-data="modelosManager()">
    ...
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Administra los modelos disponibles (solo activos).
            </p>
        </div>
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 dark:border-gray-700 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @if($m->modelo_situacion == 1) {{-- Mostrar solo activos --}}
                            <tr x-show="showModelo({{ $m->modelo_id }})" x-transition>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center space-x-2">
                                        <button @click="editModelo({{ $m->modelo_id }})"
                                        ...
                                        <button @click="deleteModelo({{ $m->modelo_id }})"
    ...
    <!-- Modal Crear/Editar (solo descripción) -->
                ...
                <form @submit="handleFormSubmit($event)">
                    <div class="mb-4">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100"
                            x-text="isEditing ? 'Editar Modelo' : 'Crear Nuevo Modelo'"></h3>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            ...
                            <input type="text"
                                x-model="formData.modelo_descripcion"
                                required
                                maxlength="50"
                                @input="validateForm()"
                                placeholder="Ej: C9, BM-F-9, SD15"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">

            ...
            <div class="lg:col-span-1">
                <div class="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow p-5">
                    ...
                    <div id="venta_info" class="space-y-1 mb-4 hidden">
                        <label for="cantidad_vendida" class="block text-sm font-medium text-slate-700 dark:text-slate-300">
                            Cantidad Vendida
                        </label>
                        <input id="cantidad_vendida" name="cantidad_vendida" type="number" placeholder="Cantidad vendida"
                            class="w-full rounded-xl border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 focus:ring-2 focus:ring-indigo-500">

                        <label for="descripcion_venta" class="block text-sm font-medium text-slate-700 dark:text-slate-300">
...
@push('styles')
    <style>
        /* Estilo para el contenedor del mapa en pantalla completa */
        #map_card:fullscreen,
        ...
        /* Asegurarte de que el mapa ocupe todo el espacio disponible */
        ...
        /* Fallback si :has() no funciona (algunos navegadores) */
        body.fullscreen-active {
            overflow: hidden !important;
        }

        /* Para ocultar la sidebar cuando el mapa esté en pantalla completa */
        #mobile-sidebar {
            z-index: 10;
        }
        ...
        #map_card.in-fullscreen #mobile-sidebar {
            ...
            /* Ocultar la sidebar en pantalla completa */
        }
    </style>
@endpush

                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select id="subcategoria"
                                                ...
                                                <label for="subcategoria"
                                                    class="block text-sm font-medium text-gray-700 mb-2">Subcategoría</label>
                                        ...
                                        <div>
                                            ...
                                            <select id="modelo"
                                                ...
                                                <label for="modelo"
                                                    class="block text-sm font-medium text-gray-700 mb-2">Modelo</label>
                                        ...
                                        <div>
                                            ...
                                            <select id="calibre"
                                                ...
                                                <label for="calibre"
                                                    class="block text-sm font-medium text-gray-700 mb-2">Calibre</label>
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                        ...
                        <div id="nuevoClienteForm" class="hidden space-y-3">
                            ...
                            <div>
                                <label for="cliente"
                                    class="block text-sm font-medium text-gray-700 mb-2">Clientes</label>
                                    ...
                                    @foreach ($metodopago as $metodo)
                                        <label class="flex items-center">
                                            <input type="radio" name="metodoPago" value="{{ $metodo->metpago_id }}"
                                                class="mr-2">
                                            <i
                                                class="fas fa-credit-card mr-2 text-blue-600"></i>{{ $metodo->metpago_descripcion }}
                                        </label>
                                    @endforeach
                            ...
                            <div class="bg-white rounded-lg shadow-md p-6">
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <input type="number" id="descuento" min="0" max="100"
                                            value="0"

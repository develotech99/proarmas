...
<script id="empresas-importacion-data" type="application/json">
@json($empresas)
</script>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" 
     x-data="empresasImportacionManager()">
    
    <!-- Header -->
    <div class="md:flex md:items-center md:justify-between mb-6">
        <div class="min-w-0 flex-1">
            <h2 class="text-2xl font-bold leading-7 text-gray-900 dark:text-black-100 sm:text-3xl sm:truncate">
                Gestión de Empresas de Importación
            </h2>
            <p class="mt-1 text-sm text-gray-500 dark:text-black-400">
                Administre las empresas de importación y sus países asociados
            </p>
        </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-gray-100" x-text="empresas.length"></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-gray-100" x-text="empresas.filter(e => e.empresaimp_situacion == 1).length"></dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900 dark:text-gray-100" x-text="empresas.filter(e => e.empresaimp_situacion == 0).length"></dd>
                        </dl>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-5">
                ...
                <div>
                    ...
                    <select x-model="paisFilter" 
                        ...
                        <template x-for="pais in paises" :key="pais.pais_id">
                            <option :value="pais.pais_id" x-text="pais.pais_descripcion"></option>
                        </template>
                    </select>
                </div>
                <div>
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 dark:border-gray-700 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <template x-for="empresa in filteredEmpresas" :key="empresa.empresaimp_id">
                                <tr x-transition>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100" x-text="empresa.empresaimp_id">
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-medium text-gray-900 dark:text-gray-100" x-text="empresa.empresaimp_descripcion">
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800" x-text="empresa.nombre_pais">
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full"
                                              :class="empresa.empresaimp_situacion == 1 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'"
                                              x-text="empresa.empresaimp_situacion == 1 ? 'Activa' : 'Inactiva'">
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400" x-text="formatDate(empresa.created_at)">
                                    </td>
                            ...
                            <tr x-show="filteredEmpresas.length === 0">
        ...
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div x-show="showModal"
                ...
                <form @submit="handleFormSubmit($event)">
                    <div class="mb-4">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100" x-text="isEditing ? 'Editar Empresa de Importación' : 'Nueva Empresa de Importación'"></h3>
                    </div>

                    <div class="grid grid-cols-1 gap-4">
                        <!-- Descripción -->
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Descripción de la empresa</label>
                            <input type="text" 

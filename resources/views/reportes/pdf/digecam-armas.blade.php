    ...
    @if(count($data) > 0)
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $index + 1 }}</td>
                    <td>{{ $venta->pro_tenencia_anterior ?? '' }}</td>
                    <td class="highlight">{{ $venta->pro_tenencia_nueva ?? '' }}</td>
                    <td>{{ $venta->tipo }}</td>
                    <td class="highlight">{{ $venta->serie }}</td>
                    <td>{{ $venta->marca ?? 'N/A' }}</td>
                    <td>{{ $venta->modelo ?? 'N/A' }}</td>
                    <td>{{ $venta->calibre ?? 'N/A' }}</td>
                    <td style="text-align: left; padding-left: 5px;">{{ strtoupper($venta->comprador) }}</td>
